  ...
  constructor(props) {
    ...
    this.state = {
      WildBook: {
        ...
        resume:
          "Réalisé du 9 mars au 27 mars 2020. Le projet avait pour but de créer une page web statique qui faisait découvrir la promotion 2020 des élèves de la Wild, réalisé avec une équipe de 3 personnes, à l’aide des langages tels que HTLM5, CSS3.",
